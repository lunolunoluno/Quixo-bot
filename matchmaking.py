...
if __name__ == "__main__":
    ...
    parser.add_argument("player_x", help=f"Bot the will play X. Must be one of the following values: {bots_list_str}", type=str)
    parser.add_argument("player_o", help=f"Bot the will play X. Must be one of the following values: {bots_list_str}", type=str)
